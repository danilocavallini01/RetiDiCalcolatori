...
{
	union {
		int visualizza_canzoni_conmenodi_v_voti_1_arg;
		Request esprimi_voto_1_arg;
	} argument;
	char *result;
	...
	case visualizza_canzoni_conmenodi_V_voti:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_Response;
		local = (char *(*)(char *, struct svc_req *)) visualizza_canzoni_conmenodi_v_voti_1_svc;
		break;
