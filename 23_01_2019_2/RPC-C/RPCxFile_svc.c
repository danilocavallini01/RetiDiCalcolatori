...
{
	union {
		char *visualizza_prenotazioni_1_arg;
		Input aggiorna_patente_1_arg;
	} argument;
	char *result;
	...
	case visualizza_prenotazioni:
		...
		local = (char *(*)(char *, struct svc_req *)) visualizza_prenotazioni_1_svc;
		break;

	case aggiorna_patente:
		_xdr_argument = (xdrproc_t) xdr_Input;
		_xdr_result = (xdrproc_t) xdr_bool;
		local = (char *(*)(char *, struct svc_req *)) aggiorna_patente_1_svc;
		break;
