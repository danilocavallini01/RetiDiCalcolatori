...
{
	union {
		char *visualizza_dati_1_arg;
		Request aggiorna_temperature_1_arg;
	} argument;
	char *result;
	...
	case visualizza_dati:
		_xdr_argument = (xdrproc_t) xdr_wrapstring;
		_xdr_result = (xdrproc_t) xdr_Response;
		local = (char *(*)(char *, struct svc_req *)) visualizza_dati_1_svc;
		break;

	case aggiorna_temperature:
		_xdr_argument = (xdrproc_t) xdr_Request;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) aggiorna_temperature_1_svc;
		break;
